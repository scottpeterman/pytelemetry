...
from PyQt6.QtCore import Qt, QTimer, QByteArray, QMargins, QThread
...
from hud import (apply_hud_styling, setup_chart_style, style_series, get_router_svg)
...
class DeviceDashboard(QMainWindow):
    ...
    # Also update the worker's facts_ready signal handling
    # Modify connect_device method
    def connect_device(self):
        """Establish connection and get initial data."""
        ...
        try:
            ...
            driver = 'nxos_ssh' if platform == 'nxos' else platform
    ...
    def update_device_info(self, facts):
        try:
            ...
            try:
                if facts.get('is_switch', 'False'):
                    svg_content = get_router_svg(True)

                else:
                    svg_content = get_router_svg(False)
            ...
            index = 0
            while index < len(key_facts):
                key, value = key_facts[index]
            ...
            # Resize columns after adding all items
    ...
    # Below is an example code snippet you can insert into your existing code to print
    # out interface statistics (text stats) as they are retrieved. This will help you
    # compare interface statuses and counters as they come in.

    # In the method where you process the interfaces and counters, add print statements.
    # For example, if you're doing this in 'update_interfaces' in device_dashboard.py,
    # after you receive the 'data' from the signals, do:
    ...
    #         i = i + 1
    #
    #     # Set X axis range to match history length
